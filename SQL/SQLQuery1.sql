...
INSERT INTO tbl_specialist
	...
	('mary', 'fischer', '123-123-1234'),
	('arnold', 'holden', '123-123-1234'),
	('kem', 'byesan', '123-123-1234'),
	('delmonte', 'fyedo', '123-123-1234')
;
...
SELECT
	...
	FROM tbl_species a1
	INNER JOIN tbl_animalia a2 ON animalia_id = a1.species_animalia
...
SELECT specialist_fname, specialist_lname, specialist_id 
FROM ((tbl_specialist
INNER JOIN tbl_care ON tbl_care.care_specialist = tbl_specialist.specialist_id)
INNER JOIN tbl_species ON tbl_species.species_id = tbl_care.care_specialist)
;
